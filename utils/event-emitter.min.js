...
class EventEmitter {
     ...
     */
    constructor(opts = EventEmitter.DEFAULT_VALUES) {
        let emitDelay, strictMode;

        if (opts.hasOwnProperty('emitDelay')) {
            emitDelay = opts.emitDelay;
        } else {
            emitDelay = EventEmitter.DEFAULT_VALUES.emitDelay;
        }
        ...
        if (opts.hasOwnProperty('strictMode')) {
            ...
            strictMode = EventEmitter.DEFAULT_VALUES.strictMode;
        }
